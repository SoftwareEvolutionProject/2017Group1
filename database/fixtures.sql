...
INSERT INTO orderedpart (orderID, digitalPartID, amount) VALUES
  ((select id from "order" where date = 2017-10-10), (select id from digitalpart where name = 'Screw'), 40),
  ((select id from "order" where date = 2017-11-01), (select id from digitalpart where name = 'Hinge'), 10);

INSERT INTO orderedpart (orderID, digitalPartID, amount) VALUES
  ((select id from "order" where date = 2017-09-09), (select id from digitalpart where name = 'Emil'), 6),
  ((select id from "order" where date = 2017-09-09), (select id from digitalpart where name = 'Emilia'), 6);
